// @ts-nocheck
/**
 * VENDORED - React Bits "AeroShards" (JS-CSS registry item, TS variant).
 * Source:  https://reactbits.dev/r/AeroShards-TS-CSS.json
 * Docs:    https://reactbits.dev/backgrounds/aero-shards
 * Runtime: vgpu@0.3.1 (WebGPU)
 *
 * Do not hand-edit: re-fetch the registry item to update.
 *
 * @ts-nocheck is scoped to this file because the upstream source is not
 * written against this project's `noUncheckedIndexedAccess`, which flags ~90
 * indexed reads inside its shader/matrix maths. Disabling the flag globally
 * to accommodate one vendored file would weaken every file we do own.
 */
